...
% condicao inicial do pendulo
x0 =[0;0;0.01;0]; %foi utilizado essa CO porque CO maiores destabilizam a MF com modelo não linear 
% x0 = [0 0.01 0.3 0]; 
% x0 = [0 0 0 0];

x0obs = [0 0 0 0]; % condicao inicial do observador, escolhido em cima do ponto de operação porem variações maiores que x0 tendem a instabilizar o sistema com estimador não linear 
% Analise do sistema
...
%Como o valor do K foi separado o calculo do estimador é independente
